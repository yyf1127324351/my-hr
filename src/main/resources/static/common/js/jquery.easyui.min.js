...
if((!opts.onlyLeafCheck)||_1c8){
	var ifedit=item.ifedit;
cc.push("<span class=\"tree-checkbox tree-checkbox0\" ifedit="+ifedit+"></span>");
}
}
...
if(_2af&&_2af.onClose){//解决进度条报错：Cannot read property 'onClose' of undefined
...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"必填",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,events:{focus:_477,blur:_47b,mouseenter:_47f,mouseleave:_482,click:function(e){
var t=$(e.data.target);
if(!t.is(":focus")){
t.trigger("focus");
}
